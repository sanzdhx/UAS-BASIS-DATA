...
<body id="page-top">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div id="obat-container">
                                            <div class="form-row mb-3 obat-item">
                                                ...
                                                <label for="harga_satuan" class="col-sm-0 col-form-label">Harga Satuan</label>
                                                <div class="col-sm-2">
                                                    <input type="number" class="form-control" name="obat[0][harga_satuan]" required>
                                                </div>
                                                <div class="col-sm-1 text-right">
                                                    <button type="button" class="btn btn-danger btn-sm remove-obat" style="display: none;">Hapus</button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        document.getElementById('add-obat').addEventListener('click', () => {
            ...
            const removeButton = newItem.querySelector('.remove-obat');
